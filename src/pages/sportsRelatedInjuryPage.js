			...
			<RouteAnimation animation={props.animation ? props.animation : ''}>
				<LayoutSection>
					...
					<Col>
						...
						<Paragraph>
							Athletes are frequently affected by cerebral concussions in both non-contact and contact sports. A cerebral concussion is considered a diffuse brain injury and is an
							alteration of mental status induced by trauma to the head. When trauma results in shaking of the brain (coup contrecoup) it can cause injury to nerve neurons and fibers in
							the brain which can result in a concussion. Medical research indicates that an athlete that has sustained a concussion in a sporting activity is 3 to 5 times more likely to
							experience another concussion at some point.
						</Paragraph>
						<Paragraph>
							When an athlete suffers head trauma, they are asked a series of questions and also asked to perform a series of physical exercises. This is typically performed by trainers
							and physicians and the series of questions and exercises are referred to as the Standardized Assessment of Concussion. It is not always comprehensive enough to diagnose
							subtle changes in mental state.
						</Paragraph>
						<Paragraph>
							Fatalities are infrequent in sports, however, when they do occur the cause is most often a traumatic brain injury. Sports brain injuries account for approximately 21
							percent of head injuries among adolescents and children in the United States.
						</Paragraph>
						<Paragraph>
						...
						<Paragraph>
							Young children should be supervised at all times and should never use sporting equipment or engage in sports that are unsuitable for their age. All rules of sporting
							activities should be followed. Appropriate clothing for a sporting activity should also always be worn while engaging in the activity and it should never interfere with
							your vision.
						</Paragraph>
						<Paragraph>
