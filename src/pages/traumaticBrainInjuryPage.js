...
// Components
import { PageHeader, HeaderImage, LayoutSection, HeaderText, Paragraph, SubHeaderText, BulletItem, BulletList } from '../components';
			...
			<LayoutSection>
				...
				<Col>
					...
					<Paragraph>
						...
						missed by primary care physicians and chiropractors that don’t recognize or otherwise miss symptoms. This leaves patients struggling to find answers for their memory issues,
						decision making and lack of planning that used to be rock solid.
					</Paragraph>
					<Paragraph>
						...
						this tragedy. You will need an attorney that is well-versed in identifying these issues, as well as have familiarity with these proceedings. Making sure you hire an attorney
						that is capable of handling all aspects of these types of cases is critical so that you and your family can focus your energy on recovering.
					</Paragraph>
					<Paragraph>
						For many years, the <strong>DOUGHERTY LAW FIRM</strong> has been litigating traumatic brain injury cases with successful results. We have the knowledge and skills necessary to
						sort through the complicated details and build a solid argument. More importantly, we have worked with doctors that have extensive experience in this area and can help you or
						your loved one start putting the pieces of their life back together.
					</Paragraph>
					...
					<Paragraph>
						We have built relationships with a large network of medical and legal professionals whom we can call upon as expert witnesses. Our familiarity with medical terminology and the
						science of brain injury treatment allow us to explain to a jury how the trauma occurred and why the defendant is at fault.
					</Paragraph>
