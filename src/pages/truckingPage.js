...
// components
import { PageHeader, LayoutSection, HeaderImage, AccordionDrop, BulletList, BulletItem, Paragraph, HeaderText, HoverServices, ImgReel, RouteAnimation } from '../components';
			...
			<RouteAnimation animation={props.animation ? props.animation : ''}>
				<LayoutSection>
					...
					<Col>
						...
						<Paragraph>
							There are special laws put in place by Federal and State Governments which regulate these large trucks and commercial vehicles and a thorough understanding of the complex
							laws and regulations relating to the trucking industry gives us a valuable edge. Our team will aggressively pursue the party at fault to make sure you, your family, or
							loved one gets the compensation they deserve for the injuries and losses that were suffered. To find out how the DOUGHERTY LAW FIRM can help you recover, contact us today
							for a free in-depth case evaluation.
						</Paragraph>
						...
						<AccordionDrop.Container>
							...
							<AccordionDrop title='improper or inadequate training'>
								...
								<Col md={6}>
									<Paragraph>
										An improperly trained truck driver lacking skills in defensive driving, handling the vehicle and other safety elements, is always a high risk to other motorists
										on the road.
									</Paragraph>
								</Col>
							</AccordionDrop>
							...
							<AccordionDrop title='improper maintenance of equipment'>
								...
								<Col md={6}>
									<Paragraph>
										...
										horrific accidents. All truck maintenance checks must be documented, which means a truck company can be held responsible for an accident/crash if poorly
										maintained equipment is found to blame.
									</Paragraph>
								</Col>
							</AccordionDrop>
							...
							<AccordionDrop title='improper load securement'>
								...
								<Col md={6}>
									<Paragraph>
										Trucking companies and their drivers are responsible for securing their loads and properly tying down any freight that is being hauled. These are typically but
										not always hauled, on flatbed trucks. They can carry anything from concrete medians to automobiles, but they are required to secure those loads properly so that
										the load doesn’t break free and/or fall off injuring or killing others.
									</Paragraph>
								</Col>
							</AccordionDrop>
							...
							<AccordionDrop title='overloading cargo & cargo securement'>
								...
								<Col md={6}>
									<Paragraph>
										An oversized load can create tire blowouts, cause the load to shift (causing uneven weight distribution) trucks to jackknife or otherwise tip over due to too
										much weight. This can cause loads to topple, send debris flying over the roadway causing other vehicles to swerve and collide.
									</Paragraph>
								</Col>
							</AccordionDrop>
							...
							<AccordionDrop title='other vehicles'>
								...
								<Col md={6}>
									<Paragraph>
										Truck drivers not only have to worry about their own driving abilities, but must keep a careful eye on other vehicles on our roadways. Often times, other
										vehicles cut in front of trucks who need much more time and distance to stop than a car.
									</Paragraph>
								</Col>
							</AccordionDrop>
							...
							<AccordionDrop title='unsafe passing'>
								...
								<Col md={6}>
									<Paragraph>
										On highways, it may be tough to gauge how much room there is when trying to pass a large truck. Drivers should always avoid passing on hills or curves, and
										avoid doing so unless there is plenty of room to pass without causing the truck driver to brake or swerve.
									</Paragraph>
								</Col>
							</AccordionDrop>
						...
						<AccordionDrop.Container>
							...
							<AccordionDrop title='tractor trailers / semi trucks'>
								...
								<Col md={6}>
									<Paragraph>
										...
										that makes them prone to roll overs. This combined with the fact that many big rig drivers are behind the wheel for long hours, tractor-trailers can be
							...
							<AccordionDrop title='tanker trucks'>
								...
								<Col md={6}>
									<Paragraph>
										A tanker truck hauls liquids or gases, many of which are classified hazardous materials. Due to their size and shape, large tankers are prone to rollovers. This
										can be extremely dangerous if the hauled liquid or gas is flammable, or if toxic substance fumes are released.
									</Paragraph>
								</Col>
							</AccordionDrop>
							...
							<AccordionDrop title='school busses'>
								...
								<Col md={6}>
									<Paragraph>
										These vehicles carry our children and oftentimes unqualified drivers are hired, with a track record of moving violations, and these drivers should never be put
										in a position of trust and protecting our children.
									</Paragraph>
								</Col>
							</AccordionDrop>
							...
							<AccordionDrop title='dump & garbage trucks'>
								...
								<Col md={6}>
									<Paragraph>
										...
										bicyclist or pedestrians walking in close proximately. These vehicles are often in residential areas and carry large loads of waste, dry materials, dirt,
										demolition debris, gravel, sand and other construction materials. The loads are often top-heavy causing a risk of large blind spots, tip-over, or falling or
										flying debris.
									</Paragraph>
								</Col>
							</AccordionDrop>
