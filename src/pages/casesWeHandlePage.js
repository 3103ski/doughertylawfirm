...
// Components
import { PageHeader, LayoutSection, ImageSlider, HeaderText, Paragraph, HoverServices, ImgReel } from '../components';
			...
			<LayoutSection className=''>
				...
				<Col md={6}>
					<Paragraph>
						...
						medical history. In turn the attorney is honest and truthful about the merits of the case and the possibility for recovery. Working together is paramount in obtaining fair and
						just compensation.
					</Paragraph>
				</Col>
				<Col md={6}>
