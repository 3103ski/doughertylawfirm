...
// Components
import { PageHeader, LayoutSection, ImageSlider, HeaderText, Paragraph, SubHeaderText, BulletItem, BulletList, HoverServices, ImgReel } from '../components';
		...
		<>
			...
			<LayoutSection>
				<Col>
					...
					<Paragraph>
						Property owners have certain obligations they must meet under local, state and federal laws. In fact, in some states a property owner has a non-delegable duty to keep his/her
						property in a safe condition. That means the owner is always on the hook, even if it’s his/her tenant is also at fault. While these laws vary, the basic concept is that
						property owners must keep their land and buildings safe for authorized visitors and those with business there.
					</Paragraph>
					<Paragraph>
						When property choose not to keep their property and buildings safe, innocent people often suffer injuries, sometimes catastrophic ones. The <strong>DOUGHERTY LAW FIRM</strong>{' '}
						IS experienced at holding property owners accountable for their negligence.
					</Paragraph>
					<Paragraph>
					...
					<Paragraph>
						Our premises liability lawyers will investigate your injury to determine its cause, and then pursue compensation on your behalf. Premises liability covers a wide range of case
						types, and it’s important when researching prospective lawyers to find an attorney with experience in the area that is most relevant to your claim.
					</Paragraph>
					<Paragraph>
