		...
		<>
			...
			<RouteAnimation>
				<LayoutSection>
					...
					<Col>
						<Paragraph>
							According to the CDC, in 2014 there were approximately 2.87 million TBI emergency department visits in the United States, including 837,000 occurring among children. In
							2014, falls were the leading cause of traumatic brain injuries accounting for almost half (48%). Being struck by or against an object was second at 17%.
						</Paragraph>
						<Paragraph>
							...
							traumatic brain injuries are still serious and medical attention should be sought immediately. A jolt, bump or blow to the head can all cause a concussion, just as falls
							and blows to the body can. The CDC reports that there has been an increase of approximately 50% in the concussion rate per 100,000 people from 2001 to 2010.
						</Paragraph>
						...
						<Col md={11} className='mx-auto'>
							...
							<Paragraph>
								Those who have experienced a mild traumatic brain injury may have difficulty remembering new information and difficulty concentrating. They also may feel slowed down
								and have difficulties thinking clearly.
							</Paragraph>
							<SubHeaderText>Emotions and Mood</SubHeaderText>
							<Paragraph>
								Those who have recently suffered a mild traumatic brain injury may be more emotional than they normally are. They may also experience irritability and anxiety as well
								as feelings of sadness and nervousness.
							</Paragraph>
							<SubHeaderText>Physical</SubHeaderText>
							<Paragraph>
								A mild traumatic brain injury may have physical symptoms such as headache, dizziness, fuzzy and/or blurred vision, and nausea. Physical symptoms may also include
								trouble balancing, lack of energy, and sensitivity to light and noise.
							</Paragraph>
						...
						<Paragraph>
							...
							recover before carrying on with your life. Without the proper time to heal, the injury may become worse over time. If you feel that you have recovered and return to your
							daily activities only to find that the symptoms return, you have not fully recovered and you should rest and consult with your doctor.
						</Paragraph>
						{/* ************** */}
						...
						<BulletList>
							...
							<BulletItem>
								Do not take drugs or drink alcohol. Taking drugs no prescribed to you or drinking alcohol may actually further injur you, so it's important to speak with your doctor
