		...
		<LayoutSection
			...
			<Col className='counter-col col-6 col-md-4 col-lg-2'>
				<Counter.Card title='scooter' line2='crash'>
					<Counter isCurrency num='2.5' after='m' speed={200} incr={1} />
				</Counter.Card>
			</Col>
			<Col className='counter-col col-6 col-md-4 col-lg-2'>
			...
			<Col className='counter-col col-6 col-md-4 col-lg-2'>
				<Counter.Card title='car' line2='crash'>
					<Counter isCurrency num='600' after='k' speed={9} incr={5} />
				</Counter.Card>
			</Col>
			<Col className='counter-col col-6 col-md-4 col-lg-2'>
				<Counter.Card title='car' line2='crash'>
					<Counter isCurrency num='525' after='k' speed={10} incr={5} />
				</Counter.Card>
			</Col>
			<Col className='counter-col col-6 col-md-4 col-lg-2'>
